...
| **02 分组** | `material organize` | LLM 根据主题**分组和标记**(写入日志 YAML 归属,保留人工标注) | 日志 front matter |
| **03 初稿** | `material distill <主题>` | 聚合条目 → **过滤次要信息 + 统一表达**形成初稿 | `materials/<主题>.md` |
| **04 定稿** | `material express <主题> [--goal]` | 根据写作目标形成定稿(缺省自动判断意图) | `materials/<主题>-定稿.md` |
...
# 3. 初稿 — 过滤次要信息 + 统一表达
material distill 写作疗愈
# → materials/写作疗愈.md(连贯初稿,无用途/渠道类信息残留)

# 4. 定稿 — 根据写作目标形成定稿
material express 写作疗愈                                    # 自动判断意图
material express 写作疗愈 --goal "写一篇用于公司账号发布的品牌故事"  # 指定目标
# → materials/写作疗愈-定稿.md
```
...
| [`02-organize-分组.md`](fiction-of-founder/02-organize-分组.md) | `organize` | 分组:日志 + YAML 主题归属(`"创作日志1": 写作疗愈`) |
| [`03-distill-初稿.md`](fiction-of-founder/03-distill-初稿.md) | `distill 写作疗愈` | 初稿:过滤次要信息 + 统一表达,连贯成篇 |
| [`04-express-定稿.md`](fiction-of-founder/04-express-定稿.md) | `express 写作疗愈 --goal "写一篇用于公司账号发布的品牌故事"` | 定稿:按写作目标 |
